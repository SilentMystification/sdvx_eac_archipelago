...
NOTE: This mod REQUIRES that you have set up the bemanitools hooks in order to intercept inputs and make them properly unlockable. These should be placed in the same folder as the d3d9 dlls.
